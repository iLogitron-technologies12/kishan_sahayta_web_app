...
<head>
  ...
  <title>Kumarghat Warehouse</title>
...
<link type="text/css" href="https://cdn.datatables.net/fixedheader/3.2.3/css/fixedHeader.dataTables.min.css" rel="stylesheet">
          ...
          <div style="overflow-x:auto;">
            <table id="example" class="display" style="width:100%; border-collapse: collapse;">
              ...
              <tbody>
                  ...
                  <tr>
                    <td>Date New</td>
                    <td>Demo Supplier 1</td>
                    <td>Invoice No. 2023</td>
                    <td>Demo Item 1</td>
                    <td>Total Grand 1</td>
                    <td>
                      <i class="fas fa-arrow-alt-circle-right" style="font-size: 26px;"></i>
                    </td>
                  </tr>
                   <tr>
                    <td>Date New</td>
