    ...
    <div class="form-background">
        ...
        <div class="container mt-2">
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-between">
                    @if(isset($land_document) && $land_document == 'not_exists' && !empty($land_document))
                    Land Document Not Uploaded!
                    @else
                    @if (isset($document_path) && Storage::disk('public')->exists($document_path))
                    <a href="{{ asset('storage/' . $document_path) }}" download>
                        Download Land Document
                    </a>
                    @endif
                    @endif

                    @if(isset($land_image) && $land_image == 'not_exists' && !empty($land_image))
                    ...
                    @else
                    <!-- 123 -->
                    @if (isset($image_path) && Storage::disk('public')->exists($image_path))
