...
<body>
    ...
    <div class="form-background">
        ...
        <div class="container mt-5">
            <div class="card">
                <div class="card-body">
                    <form method="post" route="{{ url('track-application/enter-otp/' . $phone_number) }}">
                        @csrf

                        <div class="form-group row input-field-spaces">
                            <label for="phone_number" class="col-md-12 col-form-label">Phone Number </label>
                            <div class="col-md-12">
                                <input type="text" class="form-control input-field-padding" name="phone_number" id="phone_number" value="{{ old('phone_number', $phone_number) }}" disabled>
                                @error('phone_number')
                        ...
                        Your OTP: {{ $otp }}
                        <div class="form-group row input-field-spaces">
                            <label for="otp" class="col-md-12 col-form-label">Enter OTP sent to Phone <span class="text-danger">*</span></label>
                            <div class="col-md-12">
                        ...
                        <div class="form-group row input-field-spaces">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success" id="verify_otp">Verify OTP</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#otp').on('input', function() {
                ...
                // alert(phone_number);
                var verify_otp_button = $('#verify_otp');
