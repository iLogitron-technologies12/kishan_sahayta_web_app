    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/new-application/step1">New Application<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/track-application">Track Application</a>
                </li>
                <!--<li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <h3 class="success-text">You can Submit the Application from Track Application Section!</h3> <br>
                ...
                <div class="col-md-3">
                    <div class="footer-col third">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body"><a href="login.php">Login</a></div>
                            </li>
                        </ul>
                    </div>
                </div>
