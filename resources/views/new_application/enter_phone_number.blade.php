...
<body>
    ...
    <div class="form-background">
        ...
        <h2 class="application-title"> <b>Enter Phone Number</b> </h2>

        <div class="container mt-5">
            <div class="card">
                <div class="card-body">
                    <form method="post" route=" {{ ('enter-phone-number') }}">
                        @csrf

                        <div class="form-group row input-field-spaces">
                            <label for="phone_number" class="col-md-12 col-form-label">Phone Number:</label>
                            <div class="col-md-12">
                                <input type="number" class="form-control input-field-padding" name="phone_number" placeholder="Enter Mobile Number" value="{{ old('phone_number') }}" required>
                                @error('phone_number')
